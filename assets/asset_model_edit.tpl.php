...
<!-- End Shortcut Menu -->
	...
	<?php 
		...
		// Build array of all fields to display
			$arrAssetModelFields[] = array('name' => 'Asset Model Name:', 'value' => $this->txtShortDescription->RenderWithError(false) . $this->lblShortDescription->Render(false));
			...
			$arrAssetModelFields[] = array('name' => 'Manufacturer Model Number:', 'value' => $this->lblAssetModelCode->Render(false) . $this->txtAssetModelCode->RenderWithError(false));
