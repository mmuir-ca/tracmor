...
class CommercialInvoiceForm extends QForm {
	...
	protected function lblExcel_Create() {
		...
		$this->objPHPExcel->getProperties ()->setCreator ( 'PHPOffice' )->setLastModifiedBy ( 'SAMS' )->setTitle ( 'Commercial Invoice' )->setSubject ( 'Commercial Invoice' )->setDescription ( 'Commerial Invoice generated by PHPExcel using SAMS data' )->setKeywords ( 'commercial invoice' )->setCategory ( 'commercial invoice' );
