 ...
 */
	...
	class InventoryModelListForm extends InventoryModelListFormBase {
      ...
      $this->dtgInventoryModel->AddColumn(new QDataGridColumnExt('Inventory Description', '<?= $_ITEM->ShortDescription ?>', 'Width=200', 'SortByCommand="short_description ASC"', 'ReverseSortByCommand="short_description DESC"', 'CssClass="dtg_column"'));
